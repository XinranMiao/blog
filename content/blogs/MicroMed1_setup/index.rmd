...
date: "2022-10-01"
draft: false
excerpt: Does mindfulness training affect microbiome? If so, how? In this blog, we motivate and formulate these problems in a causal mediation framework. 
subtitle: -- A Causal Mediation Perspective
title: Mindfuness and Microbiome
---
...
Thinking deeper, we have a follow-up question:
...
- What if we intervene on mediator only? $\to Y(0, M(1))$.

- What if we intervene with fixed mediator? => $Y(1, M(0))$.
...
### Takeaways
1. W are interested in the causal effect of mindfulness intervention on microbiome, with intermediate variables in between.
